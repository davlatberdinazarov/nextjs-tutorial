    ...
    <header className="text-gray-200 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <div className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <Link href="/" className="ml-3 text-xl text-white">Tailblocks</Link>
        </div>
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          <Link href="/crud" className="mr-5 hover:text-gray-100">CRUD</Link>
          <a className="mr-5 hover:text-gray-100">Second Link</a>
          <a className="mr-5 hover:text-gray-100">Third Link</a>
          <a className="mr-5 hover:text-gray-100">Fourth Link</a>
        </nav>
